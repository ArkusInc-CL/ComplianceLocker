	...
	if (adminSettings != null && adminSettings.Chatter_Compliance_paused__c==false){
		...
		if (adminSettings!=null){
        	...
        	for (FeedItem f:trigger.new){
                	...
                	for(ChatterCompliance_Word_blocker__c c:wordsNotAllowedList){
                		if (c.RecordType.DeveloperName == 'RegularExpression'){
                            ...
                            if(adminSettings.Substitute_bad_words_for_characters__c==true){
                                ...
                                postContentInformation.Original_post_content__c   =   bodySave; //originalBody;
                                ...
                                postContentInformation.Post_content__c    =   f.Body;
                                postContentInformation.FeedItemUser__c    =   Userinfo.getUserId();
                ...
                postContentInformationAux.Original_post_content__c= bodySave; //originalBody;
